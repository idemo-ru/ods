...
> Все статусы, стадии и версии приведены для примера и могут не отражать реального положения документа в топологии существования хотя я стараюсь.
{.is-danger}
