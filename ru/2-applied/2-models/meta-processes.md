...
**Примеры энтропии в мета-процессах**
Генерация альтернатив: рост энтропии (множество новых VC → высокая H).
Оценка: снижение энтропии (выбор оптимального → схлопывание неопределённости).
Рекурсия: временный рост H (вложенные уровни), затем резкое снижение после применения.
Реюз из опыта: низкий рост энтропии (заимствование проверенных → предсказуемость).
InventOperator: максимальный рост H (новые неизвестные траектории).
