...
published: true
date: 2025-12-11T10:41:00.940Z
tags: 
editor: markdown
dateCreated: 2025-12-08T00:42:25.441Z
---

## 1.1.__id__.1. Основное {#1-1-__id__-1}
...
## 1.1.__id__.2. Связанные документы {#1-1-__id__-2}
### 1.1.__id__.2.1. Исходящие *(ссылается этот документ)*
- [__numbers_path__ __form_name__~__title__](__link__.md)
- [__numbers_path__ __form_name__~__title__](__link__.md#__anchor__)
### 1.1.__id__.2.2. Входящие *(ссылаются на этот документ)*
- [__numbers_path__ __form_name__~__title__](__link__.md)
- [__numbers_path__ __form_name__~__title__](__link__.md#__anchor__)
```
Структура ссылок:
...
## 1.1.__id__.3. Термины и определения {#1-1-__id__-3}
```
Терминв и определения, используемые в документе.
```

## 1.1.__id__.4. Область применения {#1-1-__id__-4}
```
Определяет контекст, где используется данная спецификациф.
Четко разграничивает, где актуально, а где нет.
```

## 1.1.__id__.__n__. __Свободные_блоки__ {#1-1-__id__-__n__}
```
Любые дополнительные блоки, не указанные в дланном шаблоне
```

## 1.1.__id__.__n__. Заключение {#1-1-__id__-__n__}
```
