...
published: true
date: 2025-12-10T14:31:17.584Z
tags: 
editor: markdown
dateCreated: 2025-12-08T00:42:25.441Z
---

## 1.1.__id__.1. Основное {#1-2-__id__-1}
Документ описывает __одно_короткое_предложение__суть_спецификации__

> *Версия: doc.v.__lifecycle_index__.lifecycle_phase_index__.__changeflow_index__.__chengeflow_phase_index__ ∙ __месяц__ 2025*<br/><br class="hidden-wiki"/>
...
> *Текущий ChangeFlow:* #__ind__<br  class="hidden-wiki"/>
...
## 1.1.__id__.4. Область применения {#1-2-__id__-4}
```
...
> **Онлайн-версия:** https://ods.idemo.ru/ru/1-core/1-specifictions/__slug__
