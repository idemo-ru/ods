...
> IDSL — язык, в котором программируют смыслом, а не кодом.
{.is-success}
...
IDSL — это не язык программирования в классическом смысле а онтологический язык вычислительного намерения (Intent Calculus / Intent Algebra)
...
Что такое этот DSL в терминах IDSL
...
Execution
```
Это кардинально отличает IDSL от:
...
В IDSL отсутствует инфраструктурный код как часть бизнес-логики.
...
В IDSL ни одно из условий не выполняется:
	•	код временный
...
> **Онлайн-версия:** https://ods.idemo.ru/ru/1-core/1-specifictions/idsl.md
> **GitHub-версия:** https://github.com/idemo-ru/ods/blob/main/ru/1-core/1-specifictions/idsl.md