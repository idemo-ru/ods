...
Документ описывает ICSS как фформальный поверхностный синтаксис для выражения Intent-исчисления, определённого онтологией ODS и парадигмой IDEMO.
