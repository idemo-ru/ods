...
## 1.1.1.4. Метрика DegradeScore ∈ [0…1]
Единственная универсальная метрика LifeCycle определяющая текущую фазу жизненного цикла любой системы - [1.1.3. Спецификация ~ DegradeScore](/ru/1-core/1-specifictions/degrade_score.md).
