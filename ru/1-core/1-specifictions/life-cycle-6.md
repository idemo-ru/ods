...
Единственная универсальная метрика LifeCycle определяющая текущую фазу жизненного цикла любой системы. 
[смотри связанные документы](#1-1-1-2).
