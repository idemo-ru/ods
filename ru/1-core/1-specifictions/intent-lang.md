...
## tmp.1.1.6.7. Корневые процессные Intent - примитивы {#tmp-1-1-6-7}
...
## tmp.1.1.6.8. Структурные Intent {#tmp-1-1-6-8}
| Символ | Имя          | Смысл                                   |  |
|--------|--------------|-----------------------------------------|---------------------------------|
