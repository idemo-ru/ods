...
| `-->()` | fork_chain | Оператор вызова ветвлений условия /(***) (при ошибке переход в следующую ветку)| 

| `:*|` | fork_chain | Тренарный оператор условия /(*** : 1 | 2) (при ошибке переход в следующую ветку)| 
