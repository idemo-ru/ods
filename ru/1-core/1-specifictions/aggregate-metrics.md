...
**Формат:** `C-{число}-{краткое-описание}` — строка **фиксированной длины 8 байт** (ASCII), чтобы исключить коллизии и упростить машинное сравнение.
