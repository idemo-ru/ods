...
**ClassTag** (обозначение: `Tag` внутри DegradeVector) — это **короткая строка-метка**, однозначно связывающая систему с **строкой 1…6** таблицы классификации по уровню сложности и эмерджентности (см. [1.3.0.5.1](https://github.com/idemo-ru/ods/blob/main/ru/1-core/3-definitions/0-system.md#1-3-0-5-1)).
...
## 1.1.3.7. DegradeVector и фазовая аксиома {#1-1-3-7}
...
## 1.1.3.8. Практика наблюдателя {#1-1-3-8}
1. Собрать rrᵢ → RR → DS.  
